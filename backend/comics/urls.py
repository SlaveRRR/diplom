...
urlpatterns = [
    ...
    path('comics/<int:comic_id>/draft/', ComicDraftDeleteView.as_view(), name='comic-draft-delete'),
    ...
    path('comics/<int:comic_id>/visibility/', ComicVisibilityToggleView.as_view(), name='comic-visibility-toggle'),
